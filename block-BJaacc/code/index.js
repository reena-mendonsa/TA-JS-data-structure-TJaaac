...
var students ={};
// 2. Add a key of the value of variable `studentName` in the object created above 
//with the value of your name.
 students["studentName"]="Reena";
// 3. Using `console.log` log the value of `studentName` key from the `students` object
console.log(`${students.studentName}`);
// 4. Add a another key of the value of variable `batch` in the object 
//with the value of 16.
students.batch=16;
// 5. Using `console.log` log the value of `batch` key from the `students` object
console.log(`${students.batch}`);
// 6. Add another key in the object with the value of the variable `isAdult`. 
//The value of the key should be `true/false`
...
//Ans. yes we can , becasue javascript allows keywords to be used as key in objects.
...
// 13. Update the value of the key batch in the object `students` and 
