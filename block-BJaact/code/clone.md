...
console.log(person.firstName === personTwo.firstName); // output false vales at both location are differnt.
console.log(person == personTwo); // output false because now they are at different memory addresses
